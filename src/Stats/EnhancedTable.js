...
function EnhancedTableHead(props) {
    const { classes, _, order, orderBy, _, _, onRequestSort } = props;
            ...
            <TableRow>
                ...
                {props.headCells.map((headCell, ind) => {
                    return <TableCell
                        ...
                        sortDirection={orderBy === ind ? order : false}
                    >
                        <TableSortLabel
                            active={orderBy === ind}
                            direction={orderBy === ind ? order : 'asc'}
                            onClick={createSortHandler(ind)}
                        >
                            {headCell.label}
                            {orderBy === ind ? (
